...
echo_and_run cd "/home/ubuntu/catkin_ws/src/turtlebot3_autorace_2020/turtlebot3_autorace_detect"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ubuntu/catkin_ws/src/turtlebot3_autorace_2020/turtlebot3_autorace_detect/setup.py" \
     \
    build --build-base "/home/ubuntu/catkin_ws/build/turtlebot3_autorace_2020/turtlebot3_autorace_detect" \
    install \
    --root="${DESTDIR-/}" \
